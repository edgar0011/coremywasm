...
* @returns {Promise<any>}
*/
export function getGithubCommits(repo: string): Promise<any>;
/**
* @param {string | undefined} timezone
* @returns {Promise<any>}
*/
export function getWorldTime(timezone?: string): Promise<any>;
...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5c4fd5ab0f27ff09: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h9e0735b882cf6df3: (a: number, b: number, c: number, d: number) => void;
}
